    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer_type', models.CharField(choices=[('CASH', 'CASH'), ('FINANCING', 'FINANCING')], max_length=200)),
                ('reply_type', models.CharField(choices=[('ACCEPTED', 'ACCEPTED'), ('REJECTED', 'REJECTED')], max_length=200)),
                ('replied_at', models.DateField()),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listing', to='listings.property')),
